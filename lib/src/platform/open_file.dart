...
import 'package:tencent_open_file/src/common/open_result.dart';
import 'macos.dart' as mac;
import 'windows.dart' as windows;
import 'linux.dart' as linux;

class OpenFile {
  static const MethodChannel _channel = const MethodChannel('tencent_open_file');
  ...
  static Future<OpenResult> open(String? filePath,
    ...
    final _result = await _channel.invokeMethod('tencent_open_file', map);
